...
void main(void) 
{
    ...
    while(1)
    {
        ...
        while(BANDERA == 0)
        {
            BANDERA = PORTBbits.RB7 & PORTBbits.RB6 & PORTBbits.RB5;
        }
    ...
    //            if(LATBbits.LATB5){CS3++;}
                ...
                if(BANDERA)
                {
                    if(~PORTBbits.RB7){ESTADO = 1;BANDERA = 0;}
                    if(~PORTBbits.RB6){ESTADO = 2;BANDERA = 0;}
                    if(~PORTBbits.RB5){ESTADO = 3;BANDERA = 0;}
                    CTOTAL++;
                }
            }
        }
